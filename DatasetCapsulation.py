...
class QueryAndAnswer:
    def __init__(self, line, forward_asp_query, forward_opi_query,
        ...
        self.forward_asp_answer = forward_asp_answer
        self.forward_opi_answer = forward_opi_answer
        ...
        self.backward_asp_answer = backward_asp_answer
        self.backward_opi_answer = backward_opi_answer
...
class ReviewDataset(Dataset):
    ...
    def __getitem__(self, item):
        dataset_to_numpy_array = {
            ...
            'forward_asp_answer': np.array(self.dataset[item].forward_asp_answer),
            'forward_opi_answer': np.array(self.dataset[item].forward_opi_answer),
            ...
            'backward_asp_answer': np.array(self.dataset[item].backward_asp_answer),
            'backward_opi_answer': np.array(self.dataset[item].backward_opi_answer),
